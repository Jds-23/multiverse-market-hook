...
/// @notice Deploy ConditionalMarkets factory + Hook via CREATE2
contract DeployCoreScript is BaseScript {
    function run() public {
        ...
        console.log("ConditionalMarkets:", address(conditionalMarkets));
        ...
        ConditionalLMSRMarketHook hook = new ConditionalLMSRMarketHook{salt: salt}(poolManager, conditionalMarkets);
