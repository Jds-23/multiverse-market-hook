...
contract OrchestratorScript is BaseScript {
    ...
    function _deployCore() internal returns (address factory, address hook) {
        MultiverseMarkets cm = new MultiverseMarkets(poolManager);
        factory = address(cm);
        console.log("MultiverseMarkets:", factory);
        ...
        MultiverseHook h = new MultiverseHook{salt: salt}(poolManager, cm);
